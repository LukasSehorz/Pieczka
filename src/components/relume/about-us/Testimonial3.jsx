...
const StarIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="#F9AB00" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:gap-10">
          {reviews.map((r) => (
            <div
              key={r.name}
              className="flex flex-col border border-[rgba(14,42,107,0.12)] bg-white p-8 transition-shadow duration-300 hover:shadow-md"
            >
