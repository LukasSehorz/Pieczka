...
const services = [
  {
    image: "/images/service-fensterbau.jpg",
    num: "01",
    title: "Fensterbau",
    body: "Wenn Sie neue Fenster benötigen oder bestehende erneuern möchten. Wir montieren Fenster aller Art – fachgerecht, dicht und termingetreu.",
    tags: ["Fenster", "Montage", "Abdichtung"],
  },
  {
    image: "/images/service-tuerenbau.jpg",
    num: "02",
    title: "Türenbau",
    body: "Wenn Sie Innen- oder Außentüren einbauen oder austauschen möchten. Wir montieren Türen präzise und sorgen für perfekte Funktion.",
    tags: ["Innentüren", "Außentüren", "Einbau"],
  },
  {
    image: "/images/service-metalltore.jpg",
    num: "03",
    title: "Metalltore & Garagentore",
    body: "Wenn Sie ein neues Metall- oder Garagentor benötigen. Wir liefern und montieren Tore für Garagen, Einfahrten und Gewerbeobjekte.",
    tags: ["Garagentor", "Metalltor", "Einfahrt"],
  },
  {
    image: "/images/service-boden.jpg",
    num: "04",
    title: "Bodenleger & Bodenbeläge",
  ...
  },
  {
    ...
    body: "Wenn Ihr Zuhause oder Ihre Immobilie aufgefrischt werden soll. Wir übernehmen Renovierungen aller Art – sauber, zuverlässig und termingerecht.",
    tags: ["Renovierung", "Instandhaltung", "Umbau"],
  },
  {
    image: "/images/service-montage.jpg",
    num: "06",
    title: "Montagearbeiten",
    body: "Wenn Sie handwerkliche Montagearbeiten aller Art benötigen. Von der Möbelmontage bis zur Bauelement-Installation – alles aus einer Hand.",
    tags: ["Montage", "Installation", "Handwerk"],
  },
];
